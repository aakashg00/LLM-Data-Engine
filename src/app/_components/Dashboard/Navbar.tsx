...
function Navbar() {
  const [page, setPage] = useState<"home" | "dialogues">("home");

  return (
    <div>
      <aside
        id="hs-pro-sidebar"
        className="hs-overlay hs-overlay-open:translate-x-0 dark:hs-overlay-backdrop-open:bg-neutral-900/90 fixed inset-y-0 start-0 z-[5] hidden w-[260px] -translate-x-full transform border-e border-gray-200 bg-white transition-all duration-300 dark:border-neutral-700 dark:bg-neutral-800 lg:bottom-0 lg:end-auto lg:block lg:translate-x-0"
      >
        <div className="flex h-full max-h-full flex-col py-3">
          ...
          {/*  Content  */}
          <div className="[&amp;::-webkit-scrollbar]:w-2 [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-track]:bg-gray-100 [&amp;::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&amp;::-webkit-scrollbar-track]:bg-neutral-700 dark:[&amp;::-webkit-scrollbar-thumb]:bg-neutral-500 h-[calc(100%-35px)] overflow-y-auto lg:h-[calc(100%-93px)]">
            {/*  Nav  */}
            <nav
              className="hs-accordion-group flex w-full flex-col flex-wrap pb-3"
              data-hs-accordion-always-open=""
            >
              <ul>
                {/*  Link  */}
                <li className="mb-1.5 px-5">
                  <a
                    className={
                      "active-link flex gap-x-3 rounded-lg px-3 py-2 text-sm text-gray-800 hover:cursor-pointer hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:bg-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" +
                      (page === "home" ? " bg-gray-100" : "")
                    }
                    href="/dashboard"
                ...
                {/*  Link  */}
                <li className="hs-accordion mb-1.5 px-5 " id="users-accordion">
                  <button
                    type="button"
                    className="hs-accordion-toggle hs-accordion-active:bg-gray-100 dark:hs-accordion-active:bg-neutral-700 flex w-full gap-x-3 rounded-lg px-3 py-2 text-start text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                  >
                    <svg
                      className="mt-0.5 h-4 w-4 flex-shrink-0"
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    Users
                    <svg
                      className="hs-accordion-active:-rotate-180 ms-auto mt-1 h-3.5 w-3.5 flex-shrink-0 transition"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                  ...
                  >
                    ...
                    >
                      <li>
                        <a
                          className="flex gap-x-4 rounded-lg px-3 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 "
                ...
                {/*  Link  */}
                <li
                  className="hs-accordion mb-1.5 px-5 "
                ...
                <li className="mb-1.5 px-5">
                  <a
                    className={
                      "flex gap-x-3 rounded-lg px-3 py-2 text-sm text-gray-800 hover:cursor-pointer hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" +
                      (page === "dialogues" ? " bg-gray-100" : "")
                    }
                ...
                <li className="mb-1.5 px-5">
                  ...
                  >
                    <svg
                      className="mt-0.5 h-4 w-4 flex-shrink-0 text-blue-600 dark:text-blue-500"
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                    ...
                    <span className="bg-gradient-to-tr from-blue-600 to-purple-600 to-80% bg-clip-text text-transparent dark:from-blue-500 dark:to-purple-500">
                      Plans
                    </span>
                  </a>
                </li>
                ...
                {/*  Divider  */}
                <li className="mb-1.5 mt-5 border-t border-gray-200 px-8 pt-5 first:border-transparent first:pt-0 dark:border-neutral-700 dark:first:border-transparent">
                ...
                {/*  Link  */}
                <li className="mb-0.5 px-5">
                  <a
                    className="flex items-center gap-x-2 rounded-lg px-3 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-neutral-300 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                    href="../../pro/index.html"
                  >
                    <span className="flex h-6 w-6 items-center justify-center rounded-md bg-blue-600 text-white dark:bg-blue-500">
                      <svg
          ...
          {/*  Footer  */}
          <footer className="absolute inset-x-0 bottom-0 hidden border-t border-gray-200 dark:border-neutral-700 lg:block">
            {/*  Account  */}
            {/*  Project Dropdown  */}
            <div className="hs-dropdown relative flex [--auto-close:inside]">
              ...
              <button
                id="hs-pro-dnwpd"
                type="button"
                className="inline-flex w-full items-center px-7 py-3 text-start align-middle text-gray-800 focus:bg-gray-100 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
              >
                <svg
                ...
                <svg
                  className="ms-auto h-3.5 w-3.5 flex-shrink-0"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
              ...
              {/*  Dropdown  */}
              <div
                className="hs-dropdown-menu hs-dropdown-open:opacity-100 duration z-10 hidden w-60 rounded-xl bg-white opacity-0 shadow-[0_10px_40px_10px_rgba(0,0,0,0.08)] transition-[opacity,margin] dark:bg-neutral-900 dark:shadow-[0_10px_40px_10px_rgba(0,0,0,0.2)]"
                aria-labelledby="hs-pro-dnwpd"
              >
                <div className="space-y-0.5 p-1">
                  {/*  Item  */}
                  <a
                    className="block w-full rounded-lg bg-gray-100 px-3 py-2 text-start focus:bg-gray-100 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:bg-neutral-800 dark:focus:bg-neutral-800"
                    href="#"
                  >
                    <div className="flex gap-x-2">
                      <div className="self-center">
                        <svg
                          className="h-5 w-5 flex-shrink-0 text-gray-500 dark:text-neutral-500"
                          xmlns="http://www.w3.org/2000/svg"
                          width="16"
                          height="16"
                          fill="currentColor"
                      ...
                      <div className="ms-auto self-center">
                        <svg
                          className="h-4 w-4 flex-shrink-0 text-gray-800 dark:text-gray-200"
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                  ...
                  {/*  Item  */}
                  <a
                    className="block w-full rounded-lg px-3 py-2 text-start hover:bg-gray-100 focus:bg-gray-100 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                    href="#"
                  >
                    <div className="flex gap-x-2">
                      <div className="self-center">
                      ...
                      <div className="ms-auto self-center">
                        <svg
                          className="hidden h-4 w-4 flex-shrink-0"
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                ...
                <div className="border-t border-gray-200 p-1 dark:border-neutral-800">
                  <button
                    type="button"
                    className="flex w-full items-center gap-x-3 rounded-lg px-3 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none disabled:pointer-events-none disabled:opacity-50 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                  >
                    <svg
                ...
                <div className="border-t border-gray-200 p-1 dark:border-neutral-800">
                  <button
                    type="button"
                    className="flex w-full items-center gap-x-3 rounded-lg px-3 py-2 text-sm text-gray-800 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none disabled:opacity-50 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                  >
                    Sign out
